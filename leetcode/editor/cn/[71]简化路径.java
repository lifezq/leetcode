...
/**
 * 题目Id：71;
 * 题目：简化路径，simplify-path;
 * 日期：2021-10-02 21:54:17
 */
...
class P_71_SimplifyPath {
    public static void main(String[] args) {
        Solution solution = new P_71_SimplifyPath().new Solution();
        String path = solution.simplifyPath("/a/./b/../../c/");
        System.out.printf("简化后路径：%s\n", path);
    }
